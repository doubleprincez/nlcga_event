        ...
        <flux:card>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <flux:field class="md:col-span-2">
                    ...
                    <flux:input wire:model="company_name" placeholder="Company name" />
                    <flux:error name="company_name" />
                </flux:field>
                <flux:field>
                    <flux:label>Email</flux:label>
                    <flux:input type="email" wire:model="email" placeholder="company@example.com" />
                ...
                <flux:field class="md:col-span-2">
                    <flux:label>Activities</flux:label>
                    <flux:textarea wire:model="activities" rows="2" />
                </flux:field>
            </div>
        </flux:card>
