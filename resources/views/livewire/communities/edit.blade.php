...
new #[Layout('components.layouts.app')] class extends Component
{
    ...
    public function mount(Community $community): void
    {
        ...
        $this->fill($community->only(['title', 'description', 'restriction', 'status', 'community__category_id']));
    }

    public function save(): void
    {
        $this->validate(['title' => 'required|string|max:255']);
        $this->community->update($this->only(['title', 'description', 'restriction', 'status', 'community__category_id']));
        session()->flash('success', 'Community updated.');
...
<div>
    <div class="flex items-center gap-3 mb-6">
        ...
        <flux:heading size="xl">Edit Community</flux:heading>
    </div>
