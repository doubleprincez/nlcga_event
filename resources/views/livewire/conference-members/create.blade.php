...
new #[Layout('components.layouts.app')] class extends Component
{
    ...
    public function save(): void
    {
        ...
        $member = ConferenceMember::create($this->only([
            'fullName', 'email', 'phoneNumber', 'passType', 'organisation',
            'jobTitle', 'sector', 'paymentMethod', 'amountPaid', 'conference_year',
        ]));

        $member->generateUniqueCode();

        session()->flash('success', 'Conference member added.');
...
<div>
    <div class="flex items-center gap-3 mb-6">
        ...
        <flux:heading size="xl">Add Conference Member</flux:heading>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <flux:field>
                    ...
                    <flux:select wire:model="paymentMethod">
                        ...
                        <flux:select.option value="complimentary">Complimentary</flux:select.option>
                    </flux:select>
                </flux:field>
                <flux:field>
